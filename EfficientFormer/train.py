...
import model as efficientformer
...
def main(args):
    ...
    create_model = getattr(efficientformer, "efficientformer_"+args.factor)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--factor', type=str, default='l1')
    ...
    parser.add_argument('--weights', type=str, default='./weights/efficientformer_l1_1000d.pth',
