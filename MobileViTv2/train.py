...
def main(args):
    ...
    create_model = getattr(mobilevitv2, "mobilevitv2_"+args.factor)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--factor', type=str, default='050')
    ...
    parser.add_argument('--weights', type=str, default='./weights/mobilevitv2-0.5.pt',
