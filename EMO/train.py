...
def main(args):
    ...
    create_model = getattr(EMO, "EMO_"+args.factor)
    model = create_model(num_classes=args.num_classes, act_layer=args.activation).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./weights/EMO_1M.pth',
